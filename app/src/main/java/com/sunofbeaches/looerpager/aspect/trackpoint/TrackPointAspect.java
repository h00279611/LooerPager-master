package com.sunofbeaches.looerpager.aspect.trackpoint;
...
public class TrackPointAspect {
    ...
    private final String TAG ="TrackPointAspect";

    @Pointcut("execution(* com.android.server.print.UserState+.print(..))")
    ...
    @Around("printSet()")
    public void aroudJoinPrintSet(final ProceedingJoinPoint joinPoint) throws Throwable {
        Log.d(TAG, "aroudJoinPrintSet");
